...
type Lista[T any] interface {
	...
	// Iterador devuelve una instancia de un iterador para la lista enlazada.
...
type IteradorLista[T any] interface {
	...
	// Si se llama a Siguiente y el iterador itero todos los elementos entra en panico con un mensaje "El iterador termino de iterar"
	Siguiente()
	...
	// Si se llama a Borrar y el iterador itero todos los elementos entra en panico con un mensaje "El iterador termino de iterar
	Borrar() T
}
